...
describe 'CloneWar' do
  ...
  it "Returns how many clones are Brads" do
    test_war = CloneWar.new
    expect(test_war.number_of_brads_in_computer_army).to be_between(1,20)
    expect(test_war.number_of_brads_in_player_army).to be_between(1,20)
  end
  it "Returns how many clones are Angelenas" do
    test_war = CloneWar.new
    expect(test_war.number_of_angelenas_in_computer_army).to be_between(1,20)
    expect(test_war.number_of_angelenas_in_player_army).to be_between(1,20)
  end
  it "Returns how many clones are Scarlets" do
    test_war = CloneWar.new
    expect(test_war.number_of_scarlets_in_computer_army).to be_between(1,20)
    expect(test_war.number_of_scarlets_in_player_army).to be_between(1,20)
  end
  it "Returns how many clones are Bills" do
    test_war = CloneWar.new
    expect(test_war.number_of_bills_in_computer_army).to be_between(1,20)
    expect(test_war.number_of_bills_in_player_army).to be_between(1,20)
  end
end
